...
export const WeekCalendar = ({ habits, onToggle, isOwner = false }: WeekCalendarProps) => {
  ...
  return (
    <div className="bg-card rounded-2xl p-4 shadow-soft border border-border/50">
      {/* Day Headers */}
      <div className="grid grid-cols-[5rem_repeat(7,1fr)] gap-2 mb-3">
        {/* Empty column for habit label alignment */}
        <div />
        ...
        {weekDays.map(day => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`text-sm mt-0.5 mx-auto flex items-center justify-center ${isToday
                ...
                {weekDays.map(day => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`w-full aspect-square rounded-lg flex items-center justify-center transition-all ${!isInRange
